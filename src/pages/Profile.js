            ...
            <div className="my">
                ...
                <div className="my__box">
                    ...
                    <div className="input__group ">
                        ...
                        <input type="text" className="text" id="join_email" value="rkdcodus12@postech.com" disabled/>
                    </div>
                    <div className="input__group">
                        <label htmlFor="join_name">이름</label>
                        <input type="text" className="text" id="join_name" value="강채연"/>
                    ...
                    <div className="input__group">
                        ...
                        <input type="text" className="text" id="join_tel" value="010-0000-0000"/>
                        <div className="modify__box">
